...
import {RiAddCircleFill, RiDashboardFill, RiIeFill, RiUser3Fill} from 'react-icons/ri'
...
export default function SideBar() {
  ...
  return (
    ...
    >
       ...
       <LinkButton Icon={RiIeFill} text="Courses" url="courses" active={location.pathname==='/admin/courses'}/>
